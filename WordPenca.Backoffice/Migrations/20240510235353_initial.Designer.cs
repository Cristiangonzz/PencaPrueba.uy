...
namespace WordPenca.Backoffice.Migrations
{
    ...
    [Migration("20240510235353_initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ChatGrupoUsuario", b =>
                {
            ...
            modelBuilder.Entity("WordPenca.Business.Domain.ChatGrupo", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("ChatGrupoUsuario", b =>
                {
                    b.HasOne("WordPenca.Business.Domain.ChatGrupo", null)
                        .WithMany()
            ...
            modelBuilder.Entity("WordPenca.Business.Domain.ChatHistorial", b =>
                {
                    b.HasOne("WordPenca.Business.Domain.ChatGrupo", "grupo")
                        .WithOne("Historial")
